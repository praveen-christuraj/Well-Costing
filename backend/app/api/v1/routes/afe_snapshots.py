...
from app.schemas.afe_snapshots import AfeSnapshotCreateRequest, AfeSnapshotRead, EstimateAfeStatus
from app.services.afe_snapshots import EstimateAfeService
...
@router.get("/afe-snapshots/{snapshot_id}", response_model=AfeSnapshotRead)
