/** Catalogue sub-sub-classification: PDC bits, surface casing, float collars, and so on. */
...
const entity = 'item-subcategories'

const columns: GridColumn[] = [
  { field: 'code', header: 'Sub category code', required: true, sortable: true, width: '180px', placeholder: 'PDC-BITS' },
  { field: 'name', header: 'Sub category name', required: true, sortable: true, width: '240px', placeholder: 'PDC Bits' },
...
<template>
  <div class="library-page">
    <PageHeader
      ...
      description="Fine-grained, configurable sub categories for catalogue items — for example Bits → PDC bits, Casing → Surface casing, Shoes and collars → Float collars. Every sub category is user-defined here and appears on the Tangibles and other catalogue pages."
    />
    <MasterDataNav active="item-subcategories" />
    <EnterpriseGrid
      title="Item sub categories"
      singular="item sub category"
      :columns="columns"
      :filters="filters"
      ...
      import-entity="item-subcategories"
      export-entity="item-subcategories"
      default-sort="code"
